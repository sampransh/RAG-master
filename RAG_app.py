...
dict_welcome_message = {
    "english": "Hi!!! I am your Document Analyst. How can I help you?",
...
def expander_model_parameters(
    ...
    if LLM_provider == "OpenAI":
        st.session_state.openai_api_key = st.text_input(
            text_input_API_key,
            type="password",
            placeholder="Provide your OpenAI API key here",
        )
        st.session_state.google_api_key = ""
        st.session_state.hf_api_key = ""
    ...
    if LLM_provider == "Google":
        st.session_state.google_api_key = st.text_input(
            text_input_API_key,
            type="password",
            placeholder="Provide your Google API key here",
        )
        st.session_state.openai_api_key = ""
        st.session_state.hf_api_key = ""
    ...
    if LLM_provider == "HuggingFace":
        st.session_state.hf_api_key = st.text_input(
            text_input_API_key,
            type="password",
            placeholder="Provide your HuggingFace API key here",
        )
        st.session_state.openai_api_key = ""
        st.session_state.google_api_key = ""
...
def sidebar_and_documentChooser():
    ...
    with st.sidebar:
        st.caption(
            "INTELLICHAT – YOUR PERSONAL AI DATA ANALYST"
        )
        st.write("")
...
def CohereRerank_retriever(
    ...
    Parameters:
       ...
       cohere_model: the Cohere model, in ["rerank-multilingual-v3.0","rerank-english-v3.0"], default = "rerank-multilingual-v3.0"
